...
{{< hextra/hero-badge >}}
  <div class="hx-w-2 hx-h-2 hx-rounded-full hx-bg-green-400"></div>
  <span>Atuando desde novembro de 2025</span>
{{< /hextra/hero-badge >}}
...
{{< cards cols="2" >}}
  {{< card link="/promotor/notion" title="Controle de PEPS" subtitle="Planilha de validade e giro de estoque" icon="calendar" >}}
  {{< card link="/" title="Tarefas do dia" subtitle="To-do List diário pra ajudar " icon="clipboard-check" >}}
{{< /cards >}}
